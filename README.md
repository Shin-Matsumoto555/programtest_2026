...
## 1. 概要
プログラミング課題3問(programtest_2026)の提出リポジトリです。言語はJavaを使用しています。

　(1)task1: すごろくでサイコロをふる最小回数

　(2)task2: 1次元リバーシ(黒石と白石の個数)

　(3)task3: 整数xの桁の入れ替えによる最小値
...
### (1)task1: すごろくでサイコロをふる最小回数
A マスのすごろくで、スタートからゴールまでにサイコロをふる最小の回数を求めます。
